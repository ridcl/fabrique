_fabrique_ focuses on ML research, which imposes certain principles best explained in [Flax philosophy](https://flax.readthedocs.io/en/stable/philosophy.html). Here we repost them for convenience:
